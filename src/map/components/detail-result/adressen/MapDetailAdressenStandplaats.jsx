...
const MapDetailAdressenStandplaats = ({ panoUrl, standplaats, onMaximize, onPanoPreviewClick }) => (
  ...
  >
    <ul className="map-detail-result__list">
      {standplaats.indicatieGeconstateerd && (
      ...
      {standplaats.aanduidingInOnderzoek && (
        <li className="map-detail-result__notification">
          <Notification level="alert" canClose={false}>
            In onderzoek
          </Notification>
