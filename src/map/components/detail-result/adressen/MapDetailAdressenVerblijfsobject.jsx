  ...
  return (
    ...
    >
      <ul className="map-detail-result__list">
        {statusLevel && (
          <li className="map-detail-result__notification">
            <Notification level={statusLevel} canClose={false}>
              Status:
              {verblijfsobject.status.description}
            </Notification>
          </li>
        )}
        {verblijfsobject.isNevenadres && (
          <li className="map-detail-result__notification">
            <Notification level="info" canClose={false}>
              Dit is een nevenadres
            </Notification>
          </li>
        )}
        {verblijfsobject.indicatieGeconstateerd && (
          <li className="map-detail-result__notification">
        ...
        {verblijfsobject.aanduidingInOnderzoek && (
          <li className="map-detail-result__notification">
            <Notification level="alert" canClose={false}>
              In onderzoek
            </Notification>
        ...
        <MapDetailResultItem
          label="Oppervlakte"
          value={
            verblijfsobject.size ? `${verblijfsobject.size.toLocaleString('nl-NL')} m²` : 'onbekend'
          }
        />
      </ul>
    </MapDetailResultWrapper>
