...
const MapDetailEvenement = ({ panoUrl, item, onMaximize, onPanoPreviewClick }) => (
  ...
  >
    <ul className="map-detail-result__list">
      <MapDetailResultItem label="Startdatum" value={item.startdatum} />
      <MapDetailResultItem label="Einddatum" value={item.einddatum} />
      <MapDetailResultUrlItem label="Meer informatie" description={item.url} link={item.url} />
    </ul>
  </MapDetailResultWrapper>
)
