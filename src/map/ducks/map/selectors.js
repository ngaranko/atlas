...
export const getMapCenter = createSelector(
  getMap,
  mapState => mapState && mapState.viewCenter,
)
export const getMapBoundingBox = createSelector(
  getMap,
  mapState => mapState.boundingBox,
)

export const getDrawingMode = createSelector(
  getMap,
  mapState => mapState.drawingMode,
)
...
export const getGeometry = createSelector(
  getMap,
  mapState => mapState.geometry,
)
export const getShapeMarkers = createSelector(
  getMap,
  mapState => mapState.shapeMarkers,
)
export const getShapeDistanceTxt = createSelector(
  getMap,
  mapState => mapState.shapeDistanceTxt,
)

export const getCenter = createSelector(
  [getMapCenter, getPanoramaLocation],
  (mapCenter, panoramaLocation) => panoramaLocation || mapCenter,
)
...
export const getMarkerIcon = createSelector(
  getMap,
  mapState => mapState.markerIcon,
)
export const getRdGeoJsons = createSelector(
  getDetailGeoJson,
  geoJson => [geoJson],
)
...
export const isMarkerActive = createSelector(
  getDetail,
  detail => !detail,
)
export const isMapPanelActive = createSelector(
  getMap,
  map => map.mapPanelActive,
)
