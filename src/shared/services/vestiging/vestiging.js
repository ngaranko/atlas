...
import * as maatschappelijkeActiviteit from '../maatschappelijke-activiteit/maatschappelijke-activiteit';
  ...
  return fetch(uri, { headers: getAuthHeaders() })
    ...
    .then((result) => {
      ...
      return result.maatschappelijke_activiteit ?
        maatschappelijkeActiviteit.fetchByUri(result.maatschappelijke_activiteit)
        .then((mac) => ({
          ...vestigingResult,
