...
describe('The state url conversion factory', () => {
    ...
    //         it('translates a state with an empty filter to the
    // corresponding params', function () {
    //             const params = stateUrlConverter.state2params({
    //                 s: 'aap',
    //                 x: {
    //                     b: true,
    ...
    //         it('uses DEFAULT initialValues to denote the main
    // part of the state object', function () {
    //             mockedStateUrlConversion.initialValues = {
    //                 DEFAULT: {
    //                     aap: 'noot'
    //                 }
    ...
    //         it('can use a post method to post process a state when all
     // conversion has finished', function () {
