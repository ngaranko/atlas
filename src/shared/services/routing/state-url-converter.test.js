...
describe('The state url conversion factory', () => {
  it('is no longer used, so skip tests', () => {
    // TODO refactor, reactivate OR remove state-rul-converter
  ...
  //     });
  //
  //     it('can use a post method to post process a state when all conversion
  // has finished', () => {
