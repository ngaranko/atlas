  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        // All assets in sub folders (except the svg-icons sub dir, which will
        // be combined into an icon sprite)
        {
          context: 'modules/shared/assets',
          from: '!(svg-icons)/**/*',
          to: 'assets'
        },
        // The icon sprite generated by grunt and placed in the build dir
        {
