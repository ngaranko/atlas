(function () {
    ...
    dpSearchDirective.$inject = ['$timeout', 'autocompleteData', 'apiConfig', 'store', 'ACTIONS'];

    function dpSearchDirective ($timeout, autocompleteData, apiConfig, store, ACTIONS) {
        return {
            restrict: 'E',
            scope: {
                query: '@',
