describe('The dp-data-shared-pagination component', function () {
    ...
    function getComponent (currentPage, numberOfPages) {
        ...
        element = document.createElement('dp-data-shared-pagination');
    ...
    it('doesn\'t do anything if there is only one page', function () {
        ...
        expect(component.find('dp-data-shared-pagination-link').length).toBe(0);
    ...
    it('when there is pagination; four child directives handle the presentation of the buttons', function () {
        ...
        expect(component.find('dp-data-shared-pagination-link').length).toBe(4);
        expect(component.find('dp-data-shared-pagination-link').eq(0).attr('link')).toBe('vm.firstPage');
        expect(component.find('dp-data-shared-pagination-link').eq(1).attr('link')).toBe('vm.previousPage');
        expect(component.find('dp-data-shared-pagination-link').eq(2).attr('link')).toBe('vm.nextPage');
        expect(component.find('dp-data-shared-pagination-link').eq(3).attr('link')).toBe('vm.lastPage');
