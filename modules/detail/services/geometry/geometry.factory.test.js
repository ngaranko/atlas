  ...
  const mockedData = [
    ...
    },
    {
      ...
      response: {
        ...
        g_percelen: {
          href:
            'http://mocked-atlas-api.amsterdam.nl/brk/object/?a_percelen__id=NL.KAD.OnroerendeZaak.' +
            '123456',
        },
      },
    },
    {
      // G Percelen (meervoud)
      url:
        'http://mocked-atlas-api.amsterdam.nl/brk/object/?a_percelen__id=NL.KAD.OnroerendeZaak.123456',
      response: {
        results: [
          {
            _links: {
    ...
    },
    {
      ...
      response: {
        bezoekadres: {
          geometrie: {
            coordinates: [103465.6, 478466.281],
          },
        },
      },
    },
