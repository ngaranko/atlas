describe('The dp-bbga-tevredenheid component', function() {
  ...
  function getComponent(gebiedHeading, gebiedCode) {
    const element = document.createElement('dp-bbga-tevredenheid')
  ...
  it('adds colored badges to the cells with values', function() {
    ...
    expect(
      component.find(
        '.c-table tr:nth-child(1) td:nth-of-type(1) .bbga-tevredenheid__value.u-background-colo' +
          'r__thema--9',
      ).length,
    ).toBe(1)
    expect(
      component.find(
        '.c-table tr:nth-child(1) td:nth-of-type(2) .bbga-tevredenheid__value.u-background-colo' +
          'r__primary--contrast',
      ).length,
    ).toBe(1)
    ...
    expect(
      component.find(
        '.c-table tr:nth-child(2) td:nth-of-type(1) .bbga-tevredenheid__value.u-background-colo' +
          'r__thema--9',
      ).length,
    ).toBe(1)
    expect(
      component.find(
        '.c-table tr:nth-child(2) td:nth-of-type(2) .bbga-tevredenheid__value.u-background-colo' +
          'r__primary--contrast',
      ).length,
    ).toBe(1)
  })
  ...
  it('adds a legend with the name of the gebied', function() {
    ...
    expect(
      component.find(
        '.bbga-tevredenheid__legend:nth-child(1) .bbga-tevredenheid__legend__square.u-backgroun' +
          'd-color__thema--9',
      ).length,
    ).toBe(1)
    expect(
    ...
    expect(
      component.find(
        '.bbga-tevredenheid__legend:nth-child(2) .bbga-tevredenheid__legend__square.u-backgroun' +
  ...
  it("doesn't show anything if there are no known grades from the BBGA API", function() {
    ...
    expect(component.find('.c-table').length).toBe(1)
    ...
    expect(component.find('.c-table').length).toBe(0)
