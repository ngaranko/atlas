module.exports = [
    ...
    {
        name: 'kaart met 2 kaartlagen: meetbouten en kadastrale perceelgrenzen',
    ...
    {
        name: 'kaart met adressenlijst en getekende ruimte',
    ...
    {
        name: 'adressenlijst met ingetekende ruimte en 1 filter',
