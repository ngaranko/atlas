...
describe('parcel-ownership (eigendommen) module', () => {
  describe('user should be able to navigate to the parcel-ownership from the homepage', () => {
    it.skip('should open the parcel-ownership page', () => { // TODO reactivate when feature switch is enable
      // go to the homepage
      cy.visit('/');
  ...
  describe('not authenticated', () => {
    ...
    describe.skip('user should not be able to view the kadaster data', () => {
  ...
  describe('authenticated', () => {
    ...
    describe('user should be able to view the eigendommen', () => {
      describe.skip('should navigate from the homepage', () => {
        beforeEach(() => {
          // go to the homepage
          cy.visit('/');
