export default [
  ...
  },
  {
    // adressenlijst
    url:
      'http://localhost:3000/#?dsd=bag&dsp=1&dsv=TABLE&mpb=topografie&mpz=11&mpv=52.3731081:4.8932945',
    actions: ['wait for element .qa-data-selection-content to be visible'],
  },
  // TEST DOES NOT WORK IN CI
  // {
  //   // vestigingenlijst
  //   url: 'http://localhost:3000/#?dsd=hr&dsp=1&dsv=TABLE&mpb=topografie&mpz=11&mpv=52.3731081:4.8932945',
  //     actions: [
  ...
  // },
  {
    // panorama
    url:
      'http://localhost:3000/#?mpb=topografie&mpz=11&mpo=pano::T&mpv=52.3730353:4.8932471&pgn=home&sbf=Cu&' +
  ...
  //   url: 'http://localhost:3000/#?mpb=topografie&mpz=12&mpfs=T&mpo=bgem::T:kgem::T:ksec::T:kot::T:mbs::F&mpv=52.3731147:4.8933883&pgn=home&uvm=T',
  //   // actions: [
  //   //   'wait for element .c-map to be visible'
  //   // ]
  // },
  {
    ...
    url:
      'http://localhost:3000/#?mpb=topografie&mpz=12&mpo=bgem::T:kgem::T:ksec::T:kot::T:mbs::T&mpv=52.3734' +
  ...
  },
  {
    ...
    url:
      'http://localhost:3000/#?dsd=bag&dsgf=ZRcTb::3JDU2:ZRbBw::3JKwW:ZRZF8::3JFFi&dsgd=518,2%2520m%2520en' +
