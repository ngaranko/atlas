...
describe('embed module', () => {
  ...
  it('should show the user the embed preview of the map', () => {
    cy.visit(
      '/data/?center=52.3617139%2C4.8888734&lagen=bgem%3A1%7Ckgem%3A1%7Cksec%3A0%7Ckot%3A0&legenda=true&modus=kaart',
    )
    ...
    cy.url().should(
      'include',
      '?modus=kaart&center=52.3617139%2C4.8888734&embed-preview=true&lagen=bgem%3A1%7Ckgem%3A1%7Cksec%3A0%7Ckot%3A0&legenda=true',
    )
  })

  it('should show the user the embed view of the map', () => {
    cy.visit(
      '/data?center=52.3617139%2C4.8888734&embed=true&lagen=bgem%3A1%7Ckgem%3A1%7Cksec%3A0%7Ckot%3A0&legenda=true&modus=kaart',
    )
    // the header should be hidden
    cy.get(header).should('not.exist')
    // the button to go to city data should exist
    cy.get('.c-embed-button')
      .contains('City Data')
      .should('exist')
      .and('be.visible')
